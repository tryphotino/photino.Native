...
namespace PhotinoNET
{
    public partial class PhotinoWindow
    {
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)] static extern void Photino_GetAllMonitors(IntPtr instance, CppGetAllMonitorsDelegate callback);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Auto)] static extern void Photino_GetTitle(IntPtr instance, out string windowTitle);
